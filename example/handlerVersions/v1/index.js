 ...
 *                  are completely determined by the ActionReader implementation.
 *
 ...
 *
 * In this example, we're watching the "token.iost::transfer" action type and accumulating a running total using the
